...
# original
csv_online = 'https://docs.google.com/feeds/download/spreadsheets/Export?key={key}&exportFormat={format}&gid={gid}'.format(key='1q2drXOUhx_u48pu46EGZGa59zjDBDmkaqDEdAanW5wY', format='csv', gid='96957613')
...
with open(csv_origen) as csvfile:
	...
	for row in reader:
		...
		func["cargo"]["oficina"] = 'Sin datos'  # row["Telefono"]
		func["fecha_inicio"] = ""
		func["fecha_fin"] = ""
